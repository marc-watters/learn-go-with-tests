...
const (
	...
	Greeter_Introduce_FullMethodName = "/grpcserver.Greeter/Introduce"
)
...
type GreeterClient interface {
	...
	Introduce(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetReply, error)
}
...
func (c *greeterClient) Introduce(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GreetReply)
	err := c.cc.Invoke(ctx, Greeter_Introduce_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	Introduce(context.Context, *GreetRequest) (*GreetReply, error)
...
func (UnimplementedGreeterServer) Introduce(context.Context, *GreetRequest) (*GreetReply, error) {
...
func _Greeter_Introduce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).Introduce(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Greeter_Introduce_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Introduce(ctx, req.(*GreetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Greeter_Introduce_Handler,
		},
	},
